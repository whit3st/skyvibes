...
export default function SearchBar({ placeholder, getValue, makeSearch, coord }) {
    ...
    return (
        <div className="flex relative min-w-[280px] justify-end">
            <input placeholder={placeholder} onKeyUp={getValue}  className="bg-transparent transition-all border focus:bg-[rgba(255,255,255,.1)] placeholder-white placeholder-opacity-90 rounded h-[35px] w-[250px] focus:outline-[#ba6af0] px-3" type="text"/>
